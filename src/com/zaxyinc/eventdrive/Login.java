...
public class Login extends Activity implements View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//  **** DEBUG MODE *********
		//grab login info
		((EditText) findViewById(R.id.login_email)).setText("zaxy");
		((EditText) findViewById(R.id.login_password)).setText("zaxyuio");
	...
	public void onClick(View arg0){
		...
		case R.id.server_button_id:
			...
			i.setClassName("com.zaxyinc.eventdrive",
					"com.zaxyinc.eventdrive.ChangeServerURLDialog");
			startActivity(i);
			break;*/
		...
		case R.id.register_button_id:
			...
			i2.setClassName("com.zaxyinc.eventdrive",
					"com.zaxyinc.eventdrive.AddAccount");
			startActivity(i2);	  		
			break;
		}
	}
	...
	private class LoginTask extends AsyncTask<Void, Void, ApiResponse> {
		...
		protected ApiResponse doInBackground(Void... v) {
			...
			((Messagee)app).eventsController.getPosts().clearAll();
			((Messagee)app).eventsController.getPostImages().clearImages();
			
			return ((Messagee) app).eventsController.login(email, password);
		...
		protected void onPostExecute(ApiResponse response) {
			...
			//successful login
				...
				Intent i = new Intent();
				//i.setClassName("com.zaxyinc.eventdrive","com.zaxyinc.eventdrive.GoogleAuthenticationActivity");
				i.setClassName("com.zaxyinc.eventdrive","com.zaxyinc.eventdrive.EventsBoard");
